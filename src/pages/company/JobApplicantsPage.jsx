                ...
                <div className="flex items-center gap-3 w-full md:w-auto">
                    <div className="bg-slate-100 p-1 rounded-lg flex items-center">
                        ...
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-md text-sm font-medium transition-all ${viewMode === 'board' ? 'bg-white shadow text-slate-900' : 'text-slate-500 hover:text-slate-700'}`}
                        >
                            Tablero
                        </button>
                    </div>
            ...
            {viewMode === 'board' ? (
                <>
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 flex items-start gap-3">
                        ...
                        <div>
                            <h3 className="font-semibold text-blue-900">Gestiona tu flujo de contratación</h3>
                            <p className="text-sm text-blue-700 mt-1">
                                Arrastra las tarjetas de los candidatos entre las columnas para actualizar su estatus automáticamente.
                                Visualiza el progreso de cada postulante desde la solicitud hasta la contratación.
                            </p>
                        </div>
                    </div>
                    <KanbanBoard
                                    ...
                                    {selectedCandidate.user?.skills && (
                                        <div>
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {Array.isArray(selectedCandidate.user.skills) ? (
                                                    ...
                                                    selectedCandidate.user.skills.split(',').map((skill, index) => (
                                                        <span key={index} className="px-2 py-1 bg-slate-100 text-slate-700 rounded text-xs font-medium">
                                                            {skill.trim()}
                                                        </span>
                                                    ))
