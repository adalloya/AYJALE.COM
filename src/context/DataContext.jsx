...
export const DataProvider = ({ children }) => {
    ...
    return (
        <DataContext.Provider value={value}>
            {showWelcome && (
                <div
                    className={`fixed inset-0 z-[9999] flex items-center justify-center bg-white transition-opacity duration-[2000ms] ease-out ${loading ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
                >
