...
const ApplicationModal = ({ isOpen, onClose, onSubmit, jobTitle, loading, success }) => {
                ...
                <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                    {success ? (
                        <div className="text-center py-8">
                            ...
                            <h3 className="text-lg leading-6 font-medium text-gray-900">¡Postulación Exitosa!</h3>
                            <p className="mt-2 text-sm text-gray-500">
                                Tu perfil ha sido enviado a la empresa. ¡Mucha suerte!
                            </p>
                        </div>
                    ) : (
                        <>
